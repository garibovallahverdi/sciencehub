  ...
  return (
    <div className='xl:px-[80px] lg:px-[50px] md:px-[30px] px-[16px]'>
      <div className='flex flex-col gap-[20px] pb-[20px] border-b-[1px] border-[#050123] border-opacity-15'>
        <span className='md:text-[24px] text-[20px] font-medium text-[#050123]'>Paylaşımlar</span>
        <p className='md:text-[16px] text-[14px] text-[#050123]'>Şəxsi paylaşımlarınızı profilinizdə istədiyiniz kimi idarə edin.</p>
      </div>
      <div className='mt-[70px]'>
        ...
        <div className='mt-[38px] grid md:grid-cols-3 sm:grid-cols-2  lg:gap-x-[32px] gap-x-[24px] gap-y-[48px]'>
            {
                data.map(item=>{
