...
const page = () => {
  return (
    <div className='w-full mx-auto max-w-[1550px]'>
      <div className='flex items-end justify-between px-[30px] md:px-[80px] py-[23px] border-b-[1px] border-[#d9d9d9]'>
        <div className='flex items-center gap-[10px] mt-[10px] md:mt-[0px]'>
          ...
          <span className='md:text-[16px] text-[14px] text-[#050123] font-medium'>Haqqımızda</span>
        </div>
